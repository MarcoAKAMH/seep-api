...
const create = Joi.object({
  ...
  horas_permanencia: Joi.number().precision(4).allow(null).optional(),
  reproceso: Joi.boolean().truthy(1).falsy(0).allow(null).optional(),
  a_tiempo: Joi.boolean().truthy(1).falsy(0).allow(null).optional(),
  valor_mano_obra: Joi.number().precision(2).optional(),
  valor_repuestos: Joi.number().precision(2).optional(),
  valor_reparacion: Joi.number().precision(2).optional(),
  facturado: Joi.boolean().truthy(1).falsy(0).optional(),
  horas_reparacion: Joi.number().precision(2).allow(null).optional(),
  dias_reparacion: Joi.number().integer().min(-9007199254740991).max(MAX_ID).allow(null).optional(),
