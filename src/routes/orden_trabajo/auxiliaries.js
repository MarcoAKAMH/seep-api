...
const PK = ["id"];
const SELECT_FIELDS = ["id", "cliente_id", "vehiculo_id", "kilometraje", "estatus_id", "fecha_ingreso", "fecha_entrega_estimada", "servicio", "inicio_reparacion_at", "entrega_at", "a_tiempo", "valor_mano_obra", "valor_repuestos", "facturado", "horas_reparacion", "dias_reparacion", "tipo_reparacion_id", "orden_texto", "causa", "total", "created_at", "updated_at"];
const INSERT_FIELDS = ["cliente_id", "vehiculo_id", "kilometraje", "estatus_id", "fecha_ingreso", "fecha_entrega_estimada", "servicio", "inicio_reparacion_at", "entrega_at", "a_tiempo", "valor_mano_obra", "valor_repuestos", "facturado", "horas_reparacion", "dias_reparacion", "tipo_reparacion_id", "orden_texto", "causa", "total"];
const UPDATE_FIELDS = ["cliente_id", "vehiculo_id", "kilometraje", "estatus_id", "fecha_ingreso", "fecha_entrega_estimada", "servicio", "inicio_reparacion_at", "entrega_at", "a_tiempo", "valor_mano_obra", "valor_repuestos", "facturado", "horas_reparacion", "dias_reparacion", "tipo_reparacion_id", "orden_texto", "causa", "total"];
