...
const TABLE = 'orden_asignacion';
const PK = ["id"];
const SELECT_FIELDS = ["id", "orden_id", "empleado_id", "rol_en_orden", "created_at"];
const INSERT_FIELDS = ["orden_id", "empleado_id", "rol_en_orden"];
const UPDATE_FIELDS = ["orden_id", "empleado_id", "rol_en_orden"];
