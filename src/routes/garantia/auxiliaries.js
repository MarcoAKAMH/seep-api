...
const TABLE = 'garantia';
const PK = ["id"];
const SELECT_FIELDS = ["id", "orden_id", "ingreso_garantia_at", "salida_garantia_at", "dias_garantia", "created_at"];
const INSERT_FIELDS = ["orden_id", "ingreso_garantia_at", "salida_garantia_at", "dias_garantia"];
const UPDATE_FIELDS = ["orden_id", "ingreso_garantia_at", "salida_garantia_at", "dias_garantia"];
