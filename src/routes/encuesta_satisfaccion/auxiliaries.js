...
const TABLE = 'encuesta_satisfaccion';
const PK = ["id"];
const SELECT_FIELDS = ["id", "orden_id", "recomendaria", "nps", "calidad_id", "created_at"];
const INSERT_FIELDS = ["orden_id", "recomendaria", "nps", "calidad_id"];
const UPDATE_FIELDS = ["orden_id", "recomendaria", "nps", "calidad_id"];
